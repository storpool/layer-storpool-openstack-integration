...
class TestStorPoolConfig(unittest.TestCase):
    ...
    def test_check_config(self, unset_our_id, npset):
        ...
        self.assertRaises(
            sperror.StorPoolNoConfigException, testee.config_changed
        )
    ...
    def xtest_write_out_config(
        ...
        set_our_id.side_effect = lambda v: self.assertEquals(
            conf["SP_OURID"], v
        )
