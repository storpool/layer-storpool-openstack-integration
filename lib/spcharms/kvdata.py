#!/usr/bin/python
"""
Constants for use with unitdata.kv().
"""

KEY_OURID = 'storpool-config.our-id'
...
KEY_META_CONFIG = 'storpool-helper.meta-config'
KEY_META_GENERATION = 'storpool-helper.meta-generation'
